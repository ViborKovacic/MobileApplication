...
namespace Etl_Analytics_Mobile_Version_01.Class
{
    public class ExpandableListViewAdapter : BaseExpandableListAdapter
    {
        ...
        public override Java.Lang.Object GetChild(int groupPosition, int childPosition)
        {
            ...
            lstChild.TryGetValue(listGroup[groupPosition], out resoult);
            return resoult[childPosition];
        }
        ...
        public override View GetChildView(int groupPosition, int childPosition, bool isLastChild, View convertView, ViewGroup parent)
        {
            if (convertView == null)
            {
                ...
                convertView = inflater.Inflate(Resource.Layout.LogTableRow, null);
            }
        ...
        public override Java.Lang.Object GetGroup(int gorupPosition)
        {
            return listGroup[gorupPosition];
        }
        ...
        public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
        {
            ...
            {
                LayoutInflater inflater = (LayoutInflater)context.GetSystemService(Context.LayoutInflaterService);
                convertView = inflater.Inflate(Resource.Layout.LogTableGroupItem, null);
            }

            string textGroup = (string)GetGroup(groupPosition);
            TextView textViewGroup = convertView.FindViewById<TextView>(Resource.Id.dateTime);
