...
namespace Etl_Analytics_Mobile_Version_01.Class
{
    public class SlidingTabStrip : LinearLayout
    {
        ...
        private class SimpleTabColorizer : SlidingTabScrollView.TabColorizer
        {
            ...
            {
                return mIndicatorColors[position % mIndicatorColors.Length]; //it depends of how much colors you have. If there are 3 tabs than will be 3 colors /green,red,blue green,red,blue/
            }

            public int GetDividerColor(int position)
            {
                return mDividerColors[position % mDividerColors.Length]; //it depends of how much colors you have. If there are 2 tabs than will be 2 colors /green,red green,red/
            }
