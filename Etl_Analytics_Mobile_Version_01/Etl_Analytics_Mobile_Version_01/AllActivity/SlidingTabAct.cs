...
namespace Etl_Analytics_Mobile_Version_01.AllActivity
{
    ...
    public class SlidingTabAct : ActionBarActivity
    {
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            layoutContacts.Click += LayoutContacts_Click;
        }
        ...
        private void LayoutContacts_Click(object sender, System.EventArgs e)
        {
